(function(window){
  ...
  Seed.prototype = {
      ...
      drawText: function() {
        ...
        ctx.lineTo(60, 15);
          ...
          ctx.moveTo(0, 0);
          ctx.scale(0.75, 0.75);
          ctx.font = "10px Microsoft YaHei,Verdana"; // Why isn't the font size setting working?
          ctx.fillText("Tekan sini", 23, 10);
          ctx.restore();
      },
      clear: function() {
          var ctx = this.tree.ctx, cirle = this.cirle;
  ...
  Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
    ...
    // Randomly decide if a heart should be blue (about a 25% chance)
    var isBlue = random(0, 3) === 0; 
    
    if (isBlue) {
        // Generates beautiful shades of blue, cyan, and light purple
        this.color = color || 'rgb(' + random(0, 150) + ',' + random(100, 255) + ', 255)';
    } else {
        // The original formula for reds, pinks, and yellows
